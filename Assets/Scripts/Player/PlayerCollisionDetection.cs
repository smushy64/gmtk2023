...
namespace Player {
    ...
    public interface IPlayerCollisionDetectionListener {
        ...
        public void OnPlayerCollisionExit2D(PlayerController player, Collision2D other) { }
    ...
    public class PlayerCollisionDetection: MonoBehaviour {
        ...
        private void OnCollisionEnter2D(Collision2D other) {
            if (other.gameObject.CompareTag(GameTags.PLAYER_TAG)) {
                ...
                this.listener?.OnPlayerCollisionEnter2D(playerCollider.player, other);
            }
        }
        ...
        private void OnCollisionExit2D(Collision2D other) {
            if (other.gameObject.CompareTag(GameTags.PLAYER_TAG)) {
                var playerCollider = other.gameObject.GetComponent<PlayerCollider>();
                this.listener?.OnPlayerCollisionExit2D(playerCollider.player, other);
            }
        }
        ...
        private void OnTriggerEnter2D(Collider2D other) {
            if (other.gameObject.CompareTag(GameTags.PLAYER_TAG)) {
                var playerCollider = other.gameObject.GetComponent<PlayerCollider>();
                this.listener?.OnPlayerTriggerEnter2D(playerCollider.player, other);
            }
        }
        ...
        private void OnTriggerExit2D(Collider2D other) {
            if (other.gameObject.CompareTag(GameTags.PLAYER_TAG)) {
                var playerCollider = other.gameObject.GetComponent<PlayerCollider>();
                this.listener?.OnPlayerTriggerExit2D(playerCollider.player, other);
            }
        }
    }
}